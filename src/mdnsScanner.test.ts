...
describe('Shellies MdnsScanner test', () => {
  ...
  test('Run multiple test gen 1', async () => {
    const tests = [
      ...
      { id: 'shellydimmer2-98CDAC0D01BB', host: '192.168.1.219', port: 80, gen: 1 },
      ...
      { id: 'shellyht-CA969F', host: '192.168.68.173', port: 80, gen: 1 },
  ...
  test('Run multiple test gen 2 plus', async () => {
    const tests = [
      ...
      { id: 'shellyplus2pm-30C922810DA0', host: '192.168.1.229', port: 80, gen: 2 },
      { id: 'shellyplus2pm-30C92286CB68', host: '192.168.1.228', port: 80, gen: 2 },
  ...
  test('Log discovered', () => {
    expect((mdns as any).devices.size).toBeGreaterThanOrEqual(61);
    expect((mdns as any).discoveredDevices.size).toBeGreaterThanOrEqual(61);
