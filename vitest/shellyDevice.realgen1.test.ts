/**
 * @file vitest/shellyDevice.realgen1.test.ts
 * @description This file contains the tests for real gen 1 Shelly devices.
 * @author Luca Liguori
 */
...
describe('Shellies', () => {
  ...
  const coapServerStartSpy = vi.spyOn(CoapServer.prototype, 'start');
  const coapServerStopSpy = vi.spyOn(CoapServer.prototype, 'stop');
  const coapServerRegisterDeviceSpy = vi.spyOn(CoapServer.prototype, 'registerDevice');
