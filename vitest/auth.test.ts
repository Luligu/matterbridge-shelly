/**
 * @file vitest/auth.test.ts
 * @description This file contains the tests for the auth functions.
 * @author Luca Liguori
 */
...
describe('Authentication utility test', () => {
  ...
  test('createDigestShellyAuth', () => {
    ...
    expect(createDigestShellyAuth('admin', 'tango', Number.parseInt(authParams.nonce), 1234, authParams.realm)).toStrictEqual({
      algorithm: 'SHA-256',
      cnonce: 1234,
      nc: '00000001',
      nonce: 1716556501,
