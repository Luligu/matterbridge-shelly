/**
 * @file vitest/coapServer.test.ts
 * @description This file contains the tests for the CoapServer class.
 * @author Luca Liguori
 */
...
describe('Coap scanner', () => {
  ...
  test('Parse status message', async () => {
    ...
    msg.payload = JSON.stringify(msg.payloadS);
    msg.url = '/cit/s';
    const data = (coapServer as any).parseShellyMessage(msg);
    expect(data).toEqual({});
  ...
  test('Parse description message', async () => {
    (coapServer as any).deviceId.set(dimmerIp, 'shellydimmer2-98CDAC0D01BB');
    msg.rsinfo.address = dimmerIp;
    msg.payload = JSON.stringify(msg.payloadD);
    msg.url = '/cit/d';
    const data = (coapServer as any).parseShellyMessage(msg);
    expect(data).toEqual([
  ...
  test('Parse status message with parseStatus throwing', async () => {
    (coapServer as any).deviceId.set(dimmerIp, 'shellydimmer2-98CDAC0D01BB');
    msg.rsinfo.address = dimmerIp;
    msg.payload = JSON.stringify(msg.payloadS);
    msg.url = '/cit/s';
    msg.headers = { '3332': 'SHDM-2#98CDAC0D01BB#2', '3412': 123, '3420': 789 };
    const parseStatusSpy = vi.spyOn(coapServer as any, 'parseStatus').mockImplementationOnce(() => {
      throw new Error('Test parseStatus error');
    });
    const data = (coapServer as any).parseShellyMessage(msg);
    expect(data).toBeUndefined();
    expect(loggerLogSpy).toHaveBeenCalledWith(LogLevel.WARN, expect.stringContaining('Error parsing values for host'));
    parseStatusSpy.mockRestore();
  });

  test('Parse status shellydw2', async () => {
    msg.payload = JSON.stringify(loadResponse('shellydw2-483FDA825476', 'cits'));
    msg.headers[3332] = 'SHDW-1#483FDA825476#2';
    expect(msg.payload).not.toBeUndefined();
    const data_cits = (coapServer as any).parseShellyMessage(msg);
    expect(loggerLogSpy).toHaveBeenCalledWith(LogLevel.DEBUG, expect.stringContaining('Parsing CoIoT (coap) response from device'));
    expect(loggerLogSpy).toHaveBeenCalledWith(LogLevel.DEBUG, expect.stringContaining(`url: ${CYAN}/cit/s${db}`));
    expect(loggerLogSpy).toHaveBeenCalledWith(LogLevel.DEBUG, expect.stringContaining(`code: ${CYAN}2.05${db}`));
  ...
  test('Parse status shellybutton1', async () => {
    msg.payload = JSON.stringify(loadResponse('shellybutton1-485519F31EA3', 'cits'));
  ...
  test('Parse status shellymotionsensor', async () => {
    msg.payload = JSON.stringify(loadResponse('shellymotionsensor-60A42386E566', 'cits'));
  ...
  test('Parse status shellymotion2', async () => {
    msg.payload = JSON.stringify(loadResponse('shellymotion2-8CF68108A6F5', 'cits'));
  ...
  test('Parse status shellyflood', async () => {
    msg.payload = JSON.stringify(loadResponse('shellyflood-EC64C9C1DA9A', 'cits'));
  ...
  test('Parse status shellyht', async () => {
    msg.payload = JSON.stringify(loadResponse('shellyht-703523', 'cits'));
  ...
  test('Parse status shellytrv', async () => {
    msg.payload = JSON.stringify(loadResponse('shellytrv-60A423D0E032', 'cits'));
  ...
  test('Parse status shellysmoke', async () => {
    msg.payload = JSON.stringify(loadResponse('shellysmoke-XXXXXXXXXXXX', 'cits'));
  ...
  test('Parse status shellygas', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellygas-7C87CEBCECE4', 'cits'));
  ...
  test('Parse status shelly1', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shelly1-34945472A643', 'cits'));
  ...
  test('Parse status shelly1l', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shelly1l-E8DB84AAD781', 'cits'));
  ...
  test('Parse status shellybulbduo', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellybulbduo-34945479CFA4', 'cits'));
  ...
  test('Parse status shellycolorbulb', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellycolorbulb-485519EE12A7', 'cits'));
  ...
  test('Parse status shellyswitch25 mode relay', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellyswitch25-3494547BF36C', 'cits'));
  ...
  test('Parse status shellyswitch25 mode roller', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellyswitch25-3494546BBF7E', 'cits'));
  ...
  test('Parse status shellyrgbw2 mode white', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellyrgbw2-EC64C9D199AD', 'cits'));
  ...
  test('Parse status shellyrgbw2 mode color', async () => {
    ...
    msg.payload = JSON.stringify(loadResponse('shellyrgbw2-EC64C9D3FFEF', 'cits'));
  ...
  test('Parse status shellyem3', async () => {
    const citd = loadResponse('shellyem3-485519D732F4', 'citd');
    expect(citd).not.toBeUndefined();
    const desc = coapServer.parseDescription(citd);
    expect(desc).toEqual([
      { id: 1101, component: 'relay:0', property: 'state', range: '0/1' },
      { id: 6102, component: 'relay:0', property: 'overpower', range: ['0/1', '-1'] },
      { id: 4105, component: 'emeter:0', property: 'power' },
      { id: 4106, component: 'emeter:0', property: 'total' },
      { id: 4108, component: 'emeter:0', property: 'voltage' },
      { id: 4109, component: 'emeter:0', property: 'current' },
      { id: 4205, component: 'emeter:1', property: 'power' },
      { id: 4206, component: 'emeter:1', property: 'total' },
      { id: 4208, component: 'emeter:1', property: 'voltage' },
      { id: 4209, component: 'emeter:1', property: 'current' },
      { id: 4305, component: 'emeter:2', property: 'power' },
      { id: 4306, component: 'emeter:2', property: 'total' },
      { id: 4308, component: 'emeter:2', property: 'voltage' },
      { id: 4309, component: 'emeter:2', property: 'current' },
      { id: 9103, component: 'sys', property: 'cfg_rev', range: 'U16' },
    ]);

    msg.payload = JSON.stringify(loadResponse('shellyem3-485519D732F4', 'cits'));
    msg.headers[3332] = 'SHEM-3#485519D732F4#2';
    expect(msg.payload).not.toBeUndefined();
    ...
    expect(data_cits).toEqual({
      ...
      'emeter:2': { power: 0, total: 0, voltage: 235.15, current: 0.01 },
    });
  });
  ...
  test('Start server when already listening', () => {
    expect(coapServer.isListening).toBeTruthy();
  ...
  test('Register device with registerOnly', async () => {
    loggerLogSpy.mockClear();
    await coapServer.registerDevice(dimmerIp, 'shellydimmer2-98CDAC0D01BB', true);
