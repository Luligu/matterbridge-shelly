...
describe('shellyFetch', () => {
  ...
  describe('File-based fetch', () => {
    it('should fetch shelly data from JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'shelly');
    ...
    it('should fetch status data from JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'status');
    ...
    it('should fetch settings data from JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'settings');
    ...
    it('should fetch Gen2+ status data from JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'Shelly.GetStatus');
    ...
    it('should fetch Gen2+ config data from JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'Shelly.GetConfig');
    ...
    it('should fetch components data from JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'Shelly.GetComponents');
    ...
    it('should log error for unknown service in JSON file', async () => {
      ...
      const result = await shellyFetch(shelly, log, testFilePath, 'unknown');
    ...
    it('should handle file read error', async () => {
      ...
      const result = await shellyFetch(shelly, log, nonExistentFile, 'shelly');
    ...
    it('should fetch shelly data from a real device mock file', async () => {
      const result = await shellyFetch(shelly, log, path.join('src', 'mock', 'shelly2pmg3-34CDB0770C4C.json'), 'shelly');
    ...
    it('should handle non-existent mock file', async () => {
      const result = await shellyFetch(shelly, log, 'non-existent-file.json', 'shelly');

      expect(result).toBeNull();
    });

    it('should handle unknown service on a real device mock file', async () => {
      const result = await shellyFetch(shelly, log, path.join('src', 'mock', 'shelly2pmg3-34CDB0770C4C.json'), 'non-existent-service');
